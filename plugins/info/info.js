...
> *✦𝐊𝐀𝐈𝐓𝐎 𝐊𝐈𝐃 𝐁𝐎𝐓✦*`;
  ...
  await conn.sendMessage(m.chat, {
    text: msg,
    contextInfo: context(m.sender, "https://cdn.phototourl.com/free/2026-08-25-28312268-4aea-4cc2-9c7e-bf74877de3fd.jpg") }, { quoted: reply_status });
};
...
const context = (jid, img) => ({
    ...
    externalAdReply: {
        title: "هاذا بوت واتساب اسمه ✦𝐊𝐀𝐈𝐓𝐎 𝐊𝐈𝐃 𝐁𝐎𝐓✦ تم تطويره بواسطة 𝐌𝐄𝐃 𝐓𝐀𝐑",
        body: "𝐌𝐄𝐃 𝐓𝐀𝐑 😇",
        thumbnailUrl: img,
        sourceUrl: '',
        mediaType: 1,
